...
<div class="container">
    <div class="col-md-12">
        <form method="post" id="7" class="docform" style="display: none;">
            ...
            <label for="inputLastName">Организация и перечень документов</label>
            <div class="form-row">
                <div class="col">
                    <input type="text" class="form-control" placeholder="Наименование организации" id="inputmoneyPlace" name="moneyPlace" value="<?= $_COOKIE['moneyPlace'] ?>">
                </div>
                <div class="col">
                    <input type="text" class="form-control" placeholder="Перечислить документы" id="inputmoneyAddress" name="moneyAddress" value="<?= $_COOKIE['moneyAddress'] ?>">
                </div>
            </div>
            ...
            <input class="btn btn-primary" id='btn' name="doc7" type='submit' value='Submit' style="margin-top:20px; width:200px">
