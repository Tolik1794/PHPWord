...
<div class="sheet">
    ...
    <div class="form-row">
        <div>
            <a class="btn btn-secondary btn-lg active" href="/doc8.php" role="button">Download</a>
        </div>
        <div>
            <a class="btn btn-secondary btn-lg active" href="/?id=8" role="button" style="margin-left:20px;">Edit</a>
        </div>
    </div>
