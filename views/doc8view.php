...
<div class="sheet">
    ...
    <div class="form-row">
        <div>
            <a class="btn btn-secondary btn-lg active" href="/POAforSalary.php" role="button">Сохранить</a>
        </div>
        <div>
            <a class="btn btn-secondary btn-lg active" href="/?id=8" role="button" style="margin-left:20px;">Изменить</a>
        </div>
    </div>
