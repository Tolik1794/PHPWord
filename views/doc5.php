...
<div class="container">
    <div class="col-md-12">
        <form method="post" id="5" class="docform" style="display: none;">
            <!-- style="display: none;"  -->
            ...
            <label for="inputLastName">Подписать от имени</label>
            <div class="form-row">
                <div class="col">
                ...
                <div class="col">
                    <input type="text" class="form-control" placeholder="Перечислить документы" id="inputdoc" name="doc" value="<?= $_COOKIE['doc'] ?>">
                </div>
                <div class="col">
                    <input type="text" class="form-control" placeholder="Наименование организации, где будут подписаны документы" id="inputdocCompany" name="docCompany" value="<?= $_COOKIE['docCompany'] ?>">
                </div>
            </div>
            ...
            <input class="btn btn-primary"  id='btn' name="doc5" type='submit' value='Submit' style="margin-top:20px; width:200px">
