    ...
    <div class="col-md-12">
        <form method="post" id="2" class="docform" style="display: none;">
            ...
            <div class="form-row">
                ...
                <div class="col">
                    <input type="text" class="form-control" placeholder="Наименование ФСС" id="inputFSS" name="FSS" value="<?= $_COOKIE['FSS'] ?>">
                </div>
            </div>
            ...
            <input class="btn btn-primary"  id='btn' name="doc2" type='submit' value='Submit' style="margin-top:20px; width:200px">
