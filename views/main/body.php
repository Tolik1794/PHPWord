<div class="container">
    ...
    <?php if (!Session::has('login')) { ?>
        ...
        <div class="col-12">
            <h2>Войдите или зарегистрируйтесь для возможности использования системы!</h2>
        </div>
...
<?php
require_once 'views/doc1.php'; //POAGeneration
require_once 'views/doc2.php'; //POAFCC
require_once 'views/doc3.php'; //POAofTax
require_once 'views/doc4.php'; //POAforRealEstate
require_once 'views/doc5.php'; //POAsignDocuments
require_once 'views/doc6.php'; //POAtoReciveMoney
require_once 'views/doc7.php'; //POAtoReciveDocument
require_once 'views/doc8.php'; //POAforSalary
require_once 'views/doc9.php'; //POAforPension
require_once 'views/doc10.php'; //POAtoReciveMail
require_once 'views/doc11.php'; //POAtoReciveTMC
require_once 'views/doc12.php'; //RepresentationAttorney
require_once 'views/doc13.php'; //POAfromLegalEntity
require_once 'views/doc14.php'; //POAtoManageTheVehicle
require_once 'views/doc15.php'; //POAonLeavingTheChild
?>