<div class="container">
    <div class="col-md-12">
        <form method="post" id="3" class="docform" style="display: none;">
            <!-- style="display: none;"  -->
            ...
            <div class="form-row">
                ...
                <div class="col">
                    <input type="text" class="form-control" placeholder="Наименование налогового органа" id="inputnalogova" name="nalogova" value="<?= $_COOKIE['nalogova'] ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="col">
                    <label for="inputLastName">Полномочия совершать следующие действия</label>
            ...
            <input class="btn btn-primary"  id='btn' name="doc3" type='submit' value='Submit' style="margin-top:20px; width:200px">
