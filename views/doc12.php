...
<div class="container">
    <div class="col-md-12">
        <form method="post" id="12" class="docform" style="display: none;">
            ...
            <div>
                <input class="btn btn-primary" id='btn' name="doc12" type='submit' value='Submit' style="margin-top:20px; width:200px">
            </div>
        </form>
    </div>
</div>