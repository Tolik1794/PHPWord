...
<div class="container">
    <div class="col-md-12">
        <form method="post" id="9" class="docform" style="display: none;">
            ...
            <label for="inputLastName">Получить в</label>
            <div class="form-row">
                <div class="col">
                    <input type="text" class="form-control" placeholder="Наименование учреждения где выдается пенсия" id="inputcompany" name="company" value="<?= $_COOKIE['company'] ?>">
                </div>
            </div>
            ...
            <input class="btn btn-primary" id='btn' name="doc9" type='submit' value='Submit' style="margin-top:20px; width:200px">
