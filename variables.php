...
$lastNameInd = $_COOKIE['LastNameInd'];
$patronymicInd = $_COOKIE['PatronumicInd'];
$addressInd = $_COOKIE['addressInd'];

// company
$companyAddress = $_COOKIE['companyAddress'];
$company = $_COOKIE['company'];
$companyInd = $_COOKIE['companyInd'];
$position = $_COOKIE['position'];
$companyName = $_COOKIE['companyName'];
$companyNameAddress = $_COOKIE['companyNameAddress'];

// pasport
$pasportId = $_COOKIE['pasportId'];
$pasportNum = $_COOKIE['pasportNum'];
$pasportAddress = $_COOKIE['pasportAddress'];

// pasport Ind
$pasportIdInd = $_COOKIE['pasportIdInd'];
$pasportNumInd = $_COOKIE['pasportNumInd'];
$pasportAddressInd = $_COOKIE['pasportAddressInd'];

// other
$FSS = $_COOKIE['FSS'];
$authority = $_COOKIE['authority'];
$nalogova = $_COOKIE['nalogova'];
$dateTo = $_COOKIE['DateTo'];
$kvaddress = $_COOKIE['kvaddress'];
$doc = $_COOKIE['doc'];
$docCompany = $_COOKIE['docCompany'];
$TMC = $_COOKIE['TMC'];
$term = $_COOKIE['term'];

// GAI
$GAI = $_COOKIE['GAI'];
$GAICity = $_COOKIE['GAICity'];
$GAINum = $_COOKIE['GAINum'];
$GAIDate = $_COOKIE['GAIDate'];
$GIBDD = $_COOKIE['GIBDD'];
$GIBDDDate = $_COOKIE['GIBDDDate'];

// car
$car = $_COOKIE['car'];
$carDate = $_COOKIE['carDate'];
$carColor = $_COOKIE['carColor'];
$carEngine = $_COOKIE['carEngine'];
$carBody = $_COOKIE['carBody'];
$carСhassis = $_COOKIE['carСhassis'];
$carVIN = $_COOKIE['carVIN'];
...
$moneySum = $_COOKIE['moneySum'];
$moneyTo = $_COOKIE['moneyTo'];

$dateStart = $_COOKIE['dateStart'];
$dateFinish = $_COOKIE['dateFinish'];